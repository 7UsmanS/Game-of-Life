...
const int GRID_COL_SIZE = 20; // the number of column for the game grid

/**
 * a class for handling the computation of the Game of Life algorithm via displaying animation
 */
class GameOfLife {
public:
